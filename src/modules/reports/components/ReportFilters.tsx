...
export function ReportFiltersForm({ filters, onChange, coordinators, pollingPlaces }: Props) {
  ...
  const selectClass = "w-full h-10 px-3 pr-9 text-sm rounded-lg border border-slate-200 text-slate-700 focus:outline-none focus:ring-2 focus:ring-blue-500/20 focus:border-blue-500 transition-shadow appearance-none bg-white"
