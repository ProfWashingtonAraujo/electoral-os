...
async function main() {
    ...
    console.log(`✅ Removed placeholder polling place. Re-linked voters: ${relink.count}. Replacement: ${replacement.name}`);
}
main()
    .catch((e) => {
    console.error(e);
...
//# sourceMappingURL=remove-placeholder-polling-place.js.map